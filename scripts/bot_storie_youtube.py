...
def pubblica_storia_instagram(ig_user_id, page_token, video_path):
    ...
    except Exception as eDirect:
        pass

    # 2. Meta Business Bridge: la storia pubblicata sulla Pagina FB collegata viene cross-postata su IG
